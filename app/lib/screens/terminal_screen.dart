...
class _TerminalScreenState extends State<TerminalScreen> {
  ...
  void _addLine(String text) {
    ...
    setState(() => _lines.addAll(lines.where((l) => l.isNotEmpty || lines.length == 1)));
...
class _ConnectionPanel extends StatelessWidget {
  ...
  const _ConnectionPanel({
    required this.hostCtrl, required this.portCtrl,
    required this.userCtrl, required this.passCtrl,
    required this.connecting, required this.onConnect,
  });
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                flex: 3,
                child: _ConnField(ctrl: hostCtrl, label: 'Host', hint: '192.168.1.1'),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _ConnField(ctrl: portCtrl, label: 'Port',
                    keyboardType: TextInputType.number),
              ),
              const SizedBox(width: 10),
              Expanded(
                flex: 2,
                child: _ConnField(ctrl: userCtrl, label: 'Username', hint: 'root'),
              ),
              const SizedBox(width: 10),
              Expanded(
                flex: 2,
                child: _ConnField(ctrl: passCtrl, label: 'Password', obscure: true),
              ),
